...
from data_module.multitask_datamodule import IRTripletWithPOSDataModule
from training_and_evaluating_module.mutlitask_trainer import ColBERTwKWMaskDistillWithPOSTrainer
...
args.train_data_path = '../data/zalo_qa/ms_marco_format/collection_ws_pos_tags.json'
...
load_model(model, '/kaggle/input/colbert-phobert-ckpt/step_36000/model.safetensors', strict=False)
model.doc_tokenizer.raw_tokenizer = SlowTokenizerWrapper(model.doc_tokenizer.raw_tokenizer)
data_module = IRTripletWithPOSDataModule(args=args, tokenizer=(model.query_tokenizer, model.doc_tokenizer))
trainer = ColBERTwKWMaskDistillWithPOSTrainer(args)
